...
if (typeof Handlebars !== 'undefined'){
	...
	Handlebars.registerHelper('eq', function(context,ct2) {
		return context==ct2;
	});
...
function renderHandlebars(object,elementId='guestInfo'){
	var elementById = document.getElementById(elementId);
	if (elementById!=undefined){

		let template = Handlebars.compile(elementById.innerHTML);
		let innerHTML = template(object);
		document.getElementById(elementId+'Target').innerHTML = innerHTML;
